		...
		switch(opt) {
			...
			case 't':
				if((strcmp(optarg, "png") == 0) || (strcmp(optarg, "PNG") == 0)) {
					image_type = PNG_TYPE;
				} else if((strcmp(optarg, "eps") == 0) || (strcmp(optarg, "EPS") == 0)) {
					image_type = EPS_TYPE;
				} else if((strcmp(optarg, "svg") == 0) || (strcmp(optarg, "SVG") == 0)) {
					image_type = SVG_TYPE;
				} else if((strcmp(optarg, "ansi") == 0) || (strcmp(optarg, "ANSI") == 0)) {
					image_type = ANSI_TYPE;
				} else if((strcmp(optarg, "ansi256") == 0) || (strcmp(optarg, "ANSI256") == 0)) {
					image_type = ANSI256_TYPE;
				} else if((strcmp(optarg, "asciii") == 0) || (strcmp(optarg, "ASCIII") == 0)) {
					image_type = ASCIIi_TYPE;
				} else if((strcmp(optarg, "ascii") == 0) || (strcmp(optarg, "ASCII") == 0)) {
					image_type = ASCII_TYPE;
				} else if((strcmp(optarg, "utf8") == 0) || (strcmp(optarg, "UTF8") == 0)) {
					image_type = UTF8_TYPE;
				} else if((strcmp(optarg, "ansiutf8") == 0) || (strcmp(optarg, "ANSIUTF8") == 0)) {
